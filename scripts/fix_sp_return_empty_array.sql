...
-- Fix SP_Palet_ObtenerPorProceso to return empty array instead of NULL
...
AS BEGIN
    ...
    -- Return empty array if no palets found, instead of NULL
...
PRINT 'SP_Palet_ObtenerPorProceso fixed to return empty array instead of NULL';
GO
