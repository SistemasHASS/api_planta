...
-- Fix only the critical SP_Palet_ObtenerPorProceso for now
-- Other SPs can be fixed later when they're actually used
...
PRINT 'SP_Palet_ObtenerPorProceso fixed with correct SET options';
GO
