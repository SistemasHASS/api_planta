...
public sealed class GuiasRemisionServiceImpl(IGuiasRemisionRepository guiasRemisionRepository) : IGuiasRemisionService
{
    ...
    public Task<List<JsonElement>> GetGuiaRemisionAsync(
        string idempresa,
        string ruc,
        string idProyecto,
        string codigoAcopio,
        string codigoGuiaRemision)
        => guiasRemisionRepository.GetGuiaRemisionAsync(
            idempresa, ruc, idProyecto, codigoAcopio, codigoGuiaRemision);

    public Task<List<JsonElement>> EliminarGuiaRemisionAsync(
        string idempresa,
        string ruc,
        string idProyecto,
        string codigoAcopio,
        ...
        string usuario,
        string idRol)
        => guiasRemisionRepository.EliminarGuiaRemisionAsync(
            idempresa, ruc, idProyecto, codigoAcopio, codigoGuiaRemision, usuario, idRol);

    public Task<List<JsonElement>> EmitirGuiaRemisionAsync(
        string idempresa,
        string ruc,
        string idProyecto,
        string codigoAcopio,
        string codigoGuiaRemision,
        string usuario)
        => guiasRemisionRepository.EmitirGuiaRemisionAsync(
            idempresa, ruc, idProyecto, codigoAcopio, codigoGuiaRemision, usuario);

    public Task<List<JsonElement>> AnularGuiaRemisionAsync(
        string idempresa,
        string ruc,
        string idProyecto,
        string codigoAcopio,
